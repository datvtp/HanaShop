...
public class UserSearchController extends HttpServlet {
    private static final Logger logger = Logger.getLogger(UserSearchController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            logger.error("ERROR NumberFormat at UserSearchController: " + e.getMessage());
        } catch (SQLException e) {
            logger.error("ERROR SQL at UserSearchController: " + e.getMessage());
        } catch (NamingException e) {
            logger.error("ERROR Naming at UserSearchController: " + e.getMessage());
        } finally {
