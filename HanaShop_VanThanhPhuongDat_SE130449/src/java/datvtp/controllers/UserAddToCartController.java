...
public class UserAddToCartController extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger(UserAddToCartController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodDTO.setQuantity(1);
            
            shoppingCart.addToCart(foodDTO);
            session.setAttribute("CART", shoppingCart);
        } catch (Exception e) {
            logger.error("ERROR at UserAddToCartController: " + e.getMessage());
        } finally {
